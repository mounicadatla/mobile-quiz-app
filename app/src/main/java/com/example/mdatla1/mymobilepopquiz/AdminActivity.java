...
public class AdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button addbt, dltbt, updtbt, vbt,exrabtn,remainingtbtn;
        TextView tv, logtv;
        ...
        */
        ...
        exrabtn = (Button) findViewById(R.id.exrabtn);
        remainingtbtn = (Button) findViewById(R.id.remainingtbtn);
        ...
        exrabtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
